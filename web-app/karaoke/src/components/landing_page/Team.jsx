              ...
              >
                <div className="custom-card-container">
                  <Meta
                    ...
                    description={<span className="cousine-regular custom-card-description">Athulya Ganesh, an international student from India and Dubai, UAE, is pursuing a combined BSc and M.Eng in Computer Science, set to graduate in May 2024. With co-ops at Nokia, FOX Sports, Infinera, and the iCDCU Lab, Athulya aims to specialize in healthcare-tech product management in the future.</span>}
                  />
                </div>
              </Card>
            </Col>
              ...
              >
                <div className="custom-card-container">
                  <Meta
                    ...
                    description={<span className="cousine-regular custom-card-description">Jillian Aurisano, an Assistant Professor at the University of Cincinnati 
