            ...
            <Col xs={24} sm={12} md={8} lg={6}>
              ...
              >
                <Meta
                  ...
                  description={<span className="card-description">Stephanie Mullins is pursuing a BSc in Computer Science and is set to graduate at the end of April 2024. Stephanie has an interest in Computer Vision technology and is set to continue her passion in a full-time capacity at Radiance Technologies post-graduation.</span>}
                />
              </Card>
            </Col>
